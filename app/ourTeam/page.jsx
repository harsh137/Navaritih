      ...
      <section title="Founder" className="h-auto   pt-16" >
        ...
        <div className="flex md:flex-row sm:flex-col   items-center p-4 sm:p-6  dark:border-gray-700 ">
          ...
          <div className="md:ml-10 sm:ml-0 sm:mb-10 w-full border rounded-lg border-white  p-5">
            <h1 className="mt-4 text-2xl  font-semibold text-white capitalize   text-center underline">SANJIV SIR</h1>
    ...
    {/* TOP MANAGEMENT */}
      ...
      <section className="bg-gray-900">
        <div className="container px-6 py-4 mx-auto">
          <h2 className="text-center font-Baskervville  font-bold text-4xl md:pb-2  text-white underline mb-20"> Our Top Management</h2>
    ...
    <div className="container px-6 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
            <div className="flex flex-col items-center">
                <img className="object-cover w-full rounded-xl " src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt=""/>
